...
for ii = 1:1000;
    ...
    ExpParaPPA = MaPDPPA * BPVol; ExpParaPPB = MaPDPPB * BPVol; ExpParaPPC = MaPDPPC * BPVol; ExpParaPPD = MaPDPPD * BPVol; ExpParaPPE = MaPDPPE * BPVol; ExpParaPPF = MaPDPPF * BPVol; ExpParaPPG = MaPDPPG * BPVol; ExpParaPPH = MaPDPPH * BPVol; ExpParaPPI = MaPDPPI * BPVol; ExpParaPPJ = MaPDPPJ * BPVol; 
    ...
    ConcPPA = MiPPPA/BPVol; ConcPPB = MiPPPB/BPVol; ConcPPC = MiPPPC/BPVol; ConcPPD = MiPPPD/BPVol; ConcPPE = MiPPPE/BPVol; ConcPPF = MiPPPF/BPVol; ConcPPG = MiPPPG/BPVol; ConcPPH = MiPPPH/BPVol; ConcPPI = MiPPPI/BPVol; ConcPPJ = MiPPPJ/BPVol;   
    
    %Number of parasites picked up by the fly on feeding on the full 0.7 uL
    %feed volume %BP Scale
    FlyParaPPA(ii) = ConcPPA * FeedVol; FlyParaPPB(ii) = ConcPPB * FeedVol; FlyParaPPC(ii) = ConcPPC * FeedVol; FlyParaPPD(ii) = ConcPPD * FeedVol; FlyParaPPE(ii) = ConcPPE * FeedVol; FlyParaPPF(ii) = ConcPPF * FeedVol; FlyParaPPG(ii) = ConcPPG * FeedVol; FlyParaPPH(ii) = ConcPPH * FeedVol; FlyParaPPI(ii) = ConcPPI * FeedVol; FlyParaPPJ(ii) = ConcPPJ * FeedVol; 
    ...
    if PoTPPJ(ii) > 500 %This is the infection threshold
...
for ii = 1:1000;
    ...
    %Expected number of parasites
    ExpParaNPPA = MaPDNPPA * BPVol; ExpParaNPPB = MaPDNPPB * BPVol; ExpParaNPPC = MaPDNPPC * BPVol; ExpParaNPPD = MaPDNPPD * BPVol; ExpParaNPPE = MaPDNPPE * BPVol; ExpParaNPPF = MaPDNPPF * BPVol; ExpParaNPPG = MaPDNPPG * BPVol; ExpParaNPPH = MaPDPPH * BPVol; ExpParaNPPI = MaPDNPPI * BPVol; ExpParaNPPJ = MaPDNPPJ * BPVol; 
    ...
    %Concentration of parasites in BP
    ConcNPPA = MiPNPPA/BPVol; ConcNPPB = MiPNPPB/BPVol; ConcNPPC = MiPNPPC/BPVol; ConcNPPD = MiPNPPD/BPVol; ConcNPPE = MiPNPPE/BPVol; ConcNPPF = MiPNPPF/BPVol; ConcNPPG = MiPNPPG/BPVol; ConcNPPH = MiPNPPH/BPVol; ConcNPPI = MiPNPPI/BPVol; ConcNPPJ = MiPNPPJ/BPVol;   
    
    %Number of parasites picked up by the fly on feeding on the full 0.7 uL
    %feed volume %BP Scale
    FlyParaNPPA(ii) = ConcNPPA * FeedVol; FlyParaNPPB(ii) = ConcNPPB * FeedVol; FlyParaNPPC(ii) = ConcNPPC * FeedVol; FlyParaNPPD(ii) = ConcNPPD * FeedVol; FlyParaNPPE(ii) = ConcNPPE * FeedVol; FlyParaNPPF(ii) = ConcNPPF * FeedVol; FlyParaNPPG(ii) = ConcNPPG * FeedVol; FlyParaNPPH(ii) = ConcNPPH * FeedVol; FlyParaNPPI(ii) = ConcNPPI * FeedVol; FlyParaNPPJ(ii) = ConcNPPJ * FeedVol; 
    ...
    if PoTNPPJ(ii) > 500 %This is the infection threshold
...
for ii = 1:1000;    
    ...
    %Expected number of parasites
    ExpParaNPNPA = MaPDNPNPA * BPVol; ExpParaNPNPB = MaPDNPNPB * BPVol; ExpParaNPNPC = MaPDNPNPC * BPVol; ExpParaNPNPD = MaPDNPNPD * BPVol; ExpParaNPNPE = MaPDNPNPE * BPVol; ExpParaNPNPF = MaPDNPNPF * BPVol; ExpParaNPNPG = MaPDNPNPG * BPVol; ExpParaNPNPH = MaPDNPNPH * BPVol; ExpParaNPNPI = MaPDNPNPI * BPVol; ExpParaNPNPJ = MaPDNPNPJ * BPVol;
    
    %Concentration of parasites in BP
    ConcNPNPA = ExpParaNPNPA/BPVol; ConcNPNPB = ExpParaNPNPB/BPVol; ConcNPNPC = ExpParaNPNPC/BPVol; ConcNPNPD = ExpParaNPNPD/BPVol; ConcNPNPE = ExpParaNPNPE/BPVol; ConcNPNPF = ExpParaNPNPF/BPVol; ConcNPNPG = ExpParaNPNPG/BPVol; ConcNPNPH = ExpParaNPNPH/BPVol; ConcNPNPI = ExpParaNPNPI/BPVol; ConcNPNPJ = ExpParaNPNPJ/BPVol;     
    
    %Number of parasites picked up by the fly on feeding on the full 0.7 uL
    %feed volume
    FlyParaNPNPA(ii) = ConcNPNPA * FeedVol; FlyParaNPNPB(ii) = ConcNPNPB * FeedVol; FlyParaNPNPC(ii) = ConcNPNPC * FeedVol; FlyParaNPNPD(ii) = ConcNPNPD * FeedVol; FlyParaNPNPE(ii) = ConcNPNPE * FeedVol; FlyParaNPNPF(ii) = ConcNPNPF * FeedVol; FlyParaNPNPG(ii) = ConcNPNPG * FeedVol; FlyParaNPNPH(ii) = ConcNPNPH * FeedVol; FlyParaNPNPI(ii) = ConcNPNPI * FeedVol; FlyParaNPNPJ(ii) = ConcNPNPJ * FeedVol;     
    ...
    if PoTNPNPJ(ii) > 500 %This is the infection threshold
...
for ii = 1:1000;    
    ...
    %Expected number of parasites
    ExpParaPNPA = MaPDPNPA * BPVol; ExpParaPNPB = MaPDPNPB * BPVol; ExpParaPNPC = MaPDPNPC * BPVol; ExpParaPNPD = MaPDPNPD * BPVol; ExpParaPNPE = MaPDPNPE * BPVol; ExpParaPNPF = MaPDPNPF * BPVol; ExpParaPNPG = MaPDPNPG * BPVol; ExpParaPNPH = MaPDPNPH * BPVol; ExpParaPNPI = MaPDPNPI * BPVol; ExpParaPNPJ = MaPDPNPJ * BPVol;
    
    %Concentration of parasites in BP
    ConcPNPA = ExpParaPNPA/BPVol; ConcPNPB = ExpParaPNPB/BPVol; ConcPNPC = ExpParaPNPC/BPVol; ConcPNPD = ExpParaPNPD/BPVol; ConcPNPE = ExpParaPNPE/BPVol; ConcPNPF = ExpParaPNPF/BPVol; ConcPNPG = ExpParaPNPG/BPVol; ConcPNPH = ExpParaPNPH/BPVol; ConcPNPI = ExpParaPNPI/BPVol; ConcPNPJ = ExpParaPNPJ/BPVol;     
    
    %Number of parasites picked up by the fly on feeding on the full 0.7 uL
    %feed volume
    FlyParaPNPA(ii) = ConcPNPA * FeedVol; FlyParaPNPB(ii) = ConcPNPB * FeedVol; FlyParaPNPC(ii) = ConcPNPC * FeedVol; FlyParaPNPD(ii) = ConcPNPD * FeedVol; FlyParaPNPE(ii) = ConcPNPE * FeedVol; FlyParaPNPF(ii) = ConcPNPF * FeedVol; FlyParaPNPG(ii) = ConcPNPG * FeedVol; FlyParaPNPH(ii) = ConcPNPH * FeedVol; FlyParaPNPI(ii) = ConcPNPI * FeedVol; FlyParaPNPJ(ii) = ConcPNPJ * FeedVol;     
    ...
    if PoTPNPJ(ii) > 500 %This is the infection threshold
...
title('Number of Infected Flies on the BP Scale as a Function of Patchiness')